    ...
    return (
      <div className="page-content d-flex align-items-stretch">
        ...
        <ul className="list-unstyled">
          ...
          <li><Link to="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i className="icon-interface-windows" />Category </Link>
          ...
          <li><Link to="#exampledropdownDropdownprod" aria-expanded="false" data-toggle="collapse"> <i className="icon-interface-windows" />Product </Link>
          ...
          <li><Link to="#exampledropdownDropdowninv" aria-expanded="false" data-toggle="collapse"> <i className="icon-interface-windows" />Invoice </Link>
            <ul id="exampledropdownDropdowninv" className="collapse list-unstyled ">
              <li><Link to="/allinv">All Invoices</Link></li>
              <li><Link to="/editinvnpo">Add Invoice</Link></li>
